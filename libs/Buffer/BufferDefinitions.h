...
template <typename T> inline int        CountLines               (Buffer<T>* buffer_struct, const char* filename);
template <          > inline int        CountLines<char>         (Buffer<char>* text, const char* filename);
